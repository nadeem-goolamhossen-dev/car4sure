 ...
 */
final class Version20240619154227 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `person` ADD CONSTRAINT FK_34DCD1762D29E3C6 FOREIGN KEY (policy_id) REFERENCES policy (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
