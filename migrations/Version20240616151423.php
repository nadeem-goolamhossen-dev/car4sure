 ...
 */
final class Version20240616151423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, policy_id INT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, year INT NOT NULL, make VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, vin BIGINT NOT NULL, vehicle_usage VARCHAR(255) NOT NULL, primary_use VARCHAR(255) NOT NULL, annual_milleage INT NOT NULL, ownership VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_1B80E4862D29E3C6 (policy_id), INDEX IDX_1B80E486DE12AB56 (created_by), INDEX IDX_1B80E48616FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
